...
class SetCriterion(nn.Module):
    ...
    def loss_masks(self, outputs, targets):
        ...
        src_idx = (torch.zeros_like(torch.LongTensor(36)), torch.LongTensor([i*10 for i in range(36)]))
        ...
        try: 
            ...
            target_masks = target_masks.squeeze(0).flatten(1)
        except:
    ...
    def get_loss(self, loss, outputs, targets, indices, num_boxes, **kwargs):
        ...
        return loss_map[loss](outputs, targets, indices, num_boxes=None, **kwargs)
